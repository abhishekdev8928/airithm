...
const AutonomousTestingPage = () => {
  ...
  <h3 className="text-[#C44558]  text-[24px] font-[600] font-primary">
    Traditional Testing Flow
            ...
            <div className=" lg:rounded-t-[100px] rounded-t-[50px] pb-[200px] px-5 lg:px-0 py-[100px] bg-[linear-gradient(360deg,#000000_0%,#042539_100%)]">
                <SectionHeading
  ...
  {/* Card 1 */}
  <div className="lg:col-span-6 col-span-12 py-4 px-7 rounded-[16px] border border-[#999999] bg-gradient-to-b from-[rgba(255,255,255,0.1)] to-[rgba(153,153,153,0.1)]
">
    ...
    <ul className="list-disc pl-5 marker:text-[#FFA68D] mt-[20px]">
      {[
        ...
        <li key={i} className="text-[16px] font-secondary mb-[8px]">
          <span className="mae-gradient-text bg-clip-text text-transparent inline-block">
            {text}
          </span>
        </li>
      ))}
