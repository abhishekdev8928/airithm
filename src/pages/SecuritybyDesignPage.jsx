...
const SecuritybyDesignPage = () => {
                  ...
                  <SectionHeading
                    ...
                    <div className="max-w-[1221px] m-auto flex flex-wrap gap-8 mt-16">
                            ...
                            type.map((item,index, id)=>{
                                    ...
                                    return(
                                           <div id={index} className="w-[590px] rounded-2xl bg-[#fff] shadow-[0px_26px_16px_0px_#C445580D]  gap-10 p-5 px-6 flex flex-col items-start">
            ...
            <section className='py-[90px] mb-[60px] bg-[linear-gradient(360deg,#042539_0%,#000000_100%)] rounded-[100px]'>
                <div className="max-w-[1200px] m-auto grid grid-cols-12">
                    <div className="col-span-5">
                        <h2 className='font-primary text-[40px] font-[600] text-[#fff]'>Compliance Readiness</h2>
                        <p className='text-[#D9D9D9] text-[16px] font-primary'>SOC2, GDPR, HIPAA, ISO-aligned architecture ensures your organization meets the most stringent regulatory requirements from day one.</p>
                    </div>
                        ...
                        <div className="grid grid-cols-12 gap-16">
                            <div className="col-span-6 mt-8">
                                ...
                                <div className="col-span-6 bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(153,153,153,0.1)_100%)] rounded-[16px] border border-[1px] py-6 border-[#D9D9D9]">
                                        ...
                                        <p className='text-[#D9D9D9] font-secondary text-center mt-1'>Type II Compliant</p>                                        
                                    </div>
                                    <div className="col-span-6 bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(153,153,153,0.1)_100%)] rounded-[16px] border border-[1px] py-6 border-[#D9D9D9]">
                                        ...
                                        <p className='text-[#D9D9D9] font-secondary text-center mt-1'>Privacy Ready</p>                                        
                                    </div>
                                    <div className="col-span-6 bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(153,153,153,0.1)_100%)] rounded-[16px] border border-[1px] py-6 border-[#D9D9D9]">
                                        ...
                                        <p className='text-[#D9D9D9] font-secondary text-center mt-1'>Healthcare Aligned</p>                                        
                                    </div>
                                    <div className="col-span-6 bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(153,153,153,0.1)_100%)] rounded-[16px] border border-[1px] py-6 border-[#D9D9D9]">
                                        ...
                                        <p className='text-[#D9D9D9] font-secondary text-center mt-1'>Security Standards</p>                                        
                                    </div>
                                    <div className="col-span-12">
                                        <Button
  ...
  iconSize= "20px"
                            ...
                            <div className="col-span-6 px-6 py-6 border-[#D9D9D9] border border-[1px] rounded-[24px]">
                                 ...
                                 <div className="bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(131,131,131,0.1)_100%)] py-4 px-6 mt-5 flex gap-5 items-center rounded-[16px]">
                                    ...
                                    <div className="">
                                        ...
                                        <p className='text-[#999999] font-secondary text-[16px]'>Never trust, always verify</p>
                                    </div>
                                 ...
                                 <div className="bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(131,131,131,0.1)_100%)] py-4 px-6 mt-3 flex gap-5 items-center rounded-[16px]">
                                    ...
                                    <div className="">
                                        ...
                                        <p className='text-[#999999] font-secondary text-[16px]'>Continuous threat detection</p>
                                    </div>
                                 ...
                                 <div className="bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(131,131,131,0.1)_100%)] py-4 px-6 mt-3 flex gap-5 items-center rounded-[16px]">
                                    ...
                                    <div className="">
                                        ...
                                        <p className='text-[#999999] font-secondary text-[16px]'>Hardened cloud environment</p>
                                    </div>
                                 ...
                                 <div className="bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(131,131,131,0.1)_100%)] py-4 px-6 mt-3 flex gap-5 items-center rounded-[16px]">
                                    ...
                                    <div className="">
                                        ...
                                        <p className='text-[#999999] font-secondary text-[16px]'>Automated threat mitigation</p>
                                    </div>
