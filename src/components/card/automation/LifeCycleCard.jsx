...
function LifeCycleCard({ title, description, icon, iconpath }) {
  ...
  return (
    <div className="lifecycle-card border border-[#9d9d9d] w-full sm:max-w-[300px]  bg-[linear-gradient(180deg,rgba(255,255,255,0.1)_0%,rgba(153,153,153,0.1)_100%)] p-[16px] rounded-2xl">
      <div className="size-6 flex justify-center items-center rounded-sm ">
        {/* <IconComponet size="32" className="text-[#C44558]" /> */}
        <img src={iconpath} alt="" className="h-6" />
      </div>
