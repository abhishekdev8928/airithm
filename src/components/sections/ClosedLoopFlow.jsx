...
"
 ...
 text-white">
              ...
              {/* Card */}
              <div className="w-[360px] space-y-2 rounded-2xl border-light-lg bg-white p-5 shadow-sm">
 ...
 text-[#1e1e1e">
                ...
                {item.desc && (
                  <ul className="mt-3  text-sm text-slate-500">
                    {item.desc.map((d, i) => (
                      <li className="font-secondary text-[#626161] font-medium text-[16px] leading-[1.4] tracking-[0.02em] text-center capitalize
" key={i}>{d}</li>
                    ))}
                  </ul>
                )}
                ...
                {item.tags && (
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    {item.tags.map((tag, i) => (
                      <div
                        key={i}
                        className="font-primary py-4 font-medium text-[16px] leading-none tracking-[0.02em] capitalize
...
"
        ...
        {/* CTA */}
        <div className="mt-16 py-2 px-4 inline-flex items-center gap-2 rounded-full font-secondary font-medium bg-gradient-to-r from-[rgba(255,166,141,0.1)] to-[rgba(253,58,132,0.1)]
