...
" titleSize =" text-[40px]  sm:text-[48px]" subtitle={"Each layer operates independently, but shares signals through governed interfaces."} subtitleClassName="   text-[#626161] text-center
" spacing="space-y-4" />




       <div className="mt-[60px]"> {TWO_AUTOMATION_LAYERS_CONFIG.map((layer, index) => (
 ...
 ">
              <div className="p-6">
                {/* Header */}
                <div className="mb-6 rounded-2xl py-4 px-5  bg-white  flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <span className="rounded-lg size-[50px] flex justify-center items-center bg-[#C44558] font-inter font-medium text-[24px] leading-[140%] tracking-[0.04em]
 text-white">
                      {layer.level}
                    </span>
                    <h3 className="font-primary font-medium text-[20px] leading-[120%] tracking-[0.02em] capitalize text-[#1E1E1E]
">
                      {layer.title}
                    </h3>
                  </div>
                  ...
                  {/* Header Icon */}
                  <div className="rounded-lg bg-gradient-to-r from-[rgba(255,166,141,0.15)] to-[rgba(253,58,132,0.15)]
 size-12 flex items-center justify-center">
  ...
  return (
    ...
    >
      ...
      <span className="font-secondary font-medium text-[18px] leading-[140%] tracking-[0.02em] capitalize text-[#1E1E1E]
">
        {item.label}
      </span>
    </div>
