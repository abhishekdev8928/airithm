...
const ResponsibilitySection = () => {
  return (
    <section className="w-full space-y-8 rounded-[48px] bg-linear-to-b from-[#042539] to-[#000000]
 pt-24 pb-[120px]">
      {/* Title */}
      <h2 className="font-primary font-medium text-white text-[48px] leading-[140%] tracking-[0.02em] text-center capitalize
">
  ...
  return (
    <div
      key={block.title}
      className="rounded-3xl border-light-lg p-6 backdrop-blur"
    >
      {/* Header */}
      <div className="mb-6 flex items-center gap-6">
        ...
        <h3 className="font-primary py-4 font-medium text-[24px] leading-[110%] tracking-[0.02em] text-white">
          {block.title}
        </h3>
      </div>
 ...
 p-5 text-sm text-white/90. font-primary font-medium text-white text-[20px] leading-[120%] tracking-[0.02em] capitalize
"
                  >
...
font-primary font-semibold text-center rounded-[16px] text-[24px] py-[40px] leading-[120%] tracking-[0] text-white
">
