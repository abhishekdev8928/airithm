...
export const PLATFORM_FEATURES_CONFIG = {
  title: "Enterprise AI Testing & Insights",
  subtitle:
    "Unlock intelligent test generation, execution, and actionable insights across your systems",
  ...
  cards: [
    {
      ...
      cardClassName: "w-[300px] min-h-[300px] border-[#D9D9D9]",
      hasBg: true,
    },
    {
      id: 2,
  ...
  cards: [
    {
      ...
      cardClassName: "w-[300px] min-h-[300px] border-[#D9D9D9] p-4",
      hasBg: true,
    },
    {
      id: 2,
